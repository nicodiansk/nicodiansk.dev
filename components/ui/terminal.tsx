...
export const Terminal = ({
  ...
  const content = (
    <div
      ref={containerRef}
      className={cn(
        "border-cyber-cyan/30 bg-cyber-dark/90 backdrop-blur-sm z-0 h-full max-h-[400px] w-full max-w-lg rounded-xl border-2",
        className
      )}
    >
      <div className="border-cyber-cyan/30 flex flex-col gap-y-2 border-b-2 p-4">
